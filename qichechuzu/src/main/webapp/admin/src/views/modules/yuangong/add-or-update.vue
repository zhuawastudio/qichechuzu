    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="员工地址" prop="yuangongAddress">
                       <el-input v-model="ruleForm.yuangongAddress"
                                 placeholder="员工地址" clearable  :readonly="ro.yuangongAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="员工地址" prop="yuangongAddress">
                           <el-input v-model="ruleForm.yuangongAddress"
