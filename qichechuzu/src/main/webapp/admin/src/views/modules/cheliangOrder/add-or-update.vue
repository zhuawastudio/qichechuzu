    ...
    <div class="addEdit-block">
        <el-form
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出租单号" prop="cheliangOrderUuidNumber">
                       <el-input v-model="ruleForm.cheliangOrderUuidNumber"
                                 placeholder="出租单号" clearable  :readonly="ro.cheliangOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
            ...
            <input id="kehuId" name="kehuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="租车开始日期" prop="zucheKaishiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.zucheKaishiTime"
                                type="date"
                                placeholder="租车开始日期"
                                :disabled="ro.zucheKaishiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.zucheKaishiTime" label="租车开始日期" prop="zucheKaishiTime">
                            <span v-html="ruleForm.zucheKaishiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="租车结束日期" prop="zucheJieshuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.zucheJieshuTime"
                                type="date"
                                placeholder="租车结束日期"
                                :disabled="ro.zucheJieshuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.zucheJieshuTime" label="租车结束日期" prop="zucheJieshuTime">
                            <span v-html="ruleForm.zucheJieshuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12" v-if="type=='info'">
                   <el-form-item class="input" v-if="type!='info'"  label="租用天数" prop="cheliangOrderNumber">
                       <el-input v-model="ruleForm.cheliangOrderNumber"
                                 placeholder="租用天数" clearable  :readonly="ro.cheliangOrderNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="租用天数" prop="cheliangOrderNumber">
                           <el-input v-model="ruleForm.cheliangOrderNumber"
               ...
               <el-col :span="12" v-if="type=='info'">
                   <el-form-item class="input" v-if="type!='info'"  label="花费金额" prop="cheliangOrderZongJine">
                       <el-input v-model="ruleForm.cheliangOrderZongJine"
                                 placeholder="花费金额" clearable  :readonly="ro.cheliangOrderZongJine"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="花费金额" prop="cheliangOrderZongJine">
                           <el-input v-model="ruleForm.cheliangOrderZongJine"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="订单备注" prop="cheliangOrderContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.cheliangOrderContent" label="订单备注" prop="cheliangOrderContent">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yuangongId: false,
                    kehuId: false,
                    zucheKaishiTime: false,
                    zucheJieshuTime: false,
                    cheliangOrderNumber: false,
                    cheliangOrderZongJine: false,
                ...
                rules: {
                   ...
                   zucheKaishiTime: [
                              { required: true, message: '租车开始日期不能为空', trigger: 'blur' },
                          ],
                   zucheJieshuTime: [
                              { required: true, message: '租车结束日期不能为空', trigger: 'blur' },
                          ],
                   cheliangOrderNumber: [
                   ...
                   insertTime: [
                              { required: true, message: '订单录入时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
         ...
         this.$http({
             url: `cheliang/page?page=1&limit=100&cheliangZhuangtaiTypes=1`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
