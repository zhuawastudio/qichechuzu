    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="客户地址" prop="kehuAddress">
                       <el-input v-model="ruleForm.kehuAddress"
                                 placeholder="客户地址" clearable  :readonly="ro.kehuAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="客户地址" prop="kehuAddress">
                           <el-input v-model="ruleForm.kehuAddress"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="客户职业" prop="kehuZhiye">
                       <el-input v-model="ruleForm.kehuZhiye"
                                 placeholder="客户职业" clearable  :readonly="ro.kehuZhiye"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="客户职业" prop="kehuZhiye">
                           <el-input v-model="ruleForm.kehuZhiye"
                                     placeholder="客户职业" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
